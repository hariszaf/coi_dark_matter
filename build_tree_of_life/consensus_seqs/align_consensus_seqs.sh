...
mpirun.openmpi  /mnt/big/Tools/mafft-7.453-with-extensions/bin/mafft --mpi --globalpair --maxiterate 1000 non_period_all_seqs_multileline.fasta >  all_consensus_aligned.fasta
